...
public class Principal {
	...
	items.put("10", new Producto("10",15,"Agua",6));
	items.put("20", new Producto("20",25,"Coca Cola",10));
	items.put("30", new Producto("30",30,"Submarinos",3));
	items.put("40", new Producto("40",10,"Cacahuates",5));
	items.put("50", new Producto("50",26,"Sabritas",1));
